> Historical Flutter implementation, retained for reference and Android continuity. The active native iOS app and current build instructions are in the [root README](../../README.md). Status claims below describe the pre-conversion implementation.
